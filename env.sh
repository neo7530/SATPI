...
export CXXPREFIX=/opt/toolchains/stbgcc-6.3-1.8/bin/arm-linux-
export CXXSUFFIX=
export CXX=/opt/toolchains/stbgcc-6.3-1.8/bin/arm-linux-c++
export CPP=/opt/toolchains/stbgcc-6.3-1.8/bin/arm-linux-cpp
export CC=/opt/toolchains/stbgcc-6.3-1.8/bin/arm-linux-gcc
export PYTHON_CPPFLAGS=/opt/toolchains/stbgcc-6.3-1.8/python-runtime/include/python2.7
